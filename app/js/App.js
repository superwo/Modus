...
var Carousel = function () {
  function Carousel() {
    ...
    this.carousel = (0, _jquery2.default)('.banner__list');
    this.carousel.slick({
      dots: true,
      speed: 600,
      arrows: false,
...
var _mixitup = __webpack_require__(10);
...
var Mixitup = function () {
  ...
  _createClass(Mixitup, [{
    key: 'events',
    value: function events() {
      this.links.on('click', function (event) {
        event.preventDefault();
        (0, _jquery2.default)('.btn--filters').removeClass('btn--active');
        (0, _jquery2.default)(this).addClass('btn--active');
      });
    }
...
var _magnificPopup = __webpack_require__(9);
...
var Popup = function () {
  function Popup() {
    ...
    // cache elements from page
    this.imgs = (0, _jquery2.default)('.portfolio__cert-link');
  ...
  _createClass(Popup, [{
    ...
    value: function setId(e) {
      ...
      th.attr('href', '#portfolio-img-' + e).find('.portfolio__item-descr').attr('id', 'portfolio-img-' + e);
    }
    // showPopup(e) {
    //   e.preventDefault();
...
var StickFooter = function () {
  ...
  _createClass(StickFooter, [{
    ...
    value: function hf() {
      ...
      var h_footer = (0, _jquery2.default)('.mainfooter').height();
...
var _TestModule = __webpack_require__(8);

var _TestModule2 = _interopRequireDefault(_TestModule);

var _StickFooter = __webpack_require__(7);
...
var _Mixitup = __webpack_require__(3);
...
var _NavigationToggle = __webpack_require__(4);
